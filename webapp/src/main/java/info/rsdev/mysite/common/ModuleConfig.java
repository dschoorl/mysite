...
public interface ModuleConfig {
    ...
    /**
     * Get the part of the URL that the mysite application is mounted to; this is the web application's context
     * path plus the part that the {@link SiteServant} servlet is mapped to. the context path returned ends with 
     * a forward slash (/).
     * @return
     */
