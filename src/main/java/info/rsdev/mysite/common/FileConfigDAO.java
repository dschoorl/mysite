...
public class FileConfigDAO implements ConfigDAI, ConfigKeys {
    ...
    public static interface DefaultConfigKeys {
         ...
         */
        public static String MODULECONFIGTYPE_KEY = "ModuleConfigType";
    }
